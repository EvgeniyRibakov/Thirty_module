...
#           ssh-keyscan -H 158.160.173.153 >> ~/.ssh/known_hosts 2>/dev/null || echo "Warning: Failed to fetch host key, proceeding anyway"
#           echo "SSH setup completed. Verifying key permissions..."
#           ls -l ~/.ssh/id_ed25519
#         env:
...
#           echo "DJANGO_SECRET_KEY=${{ env.SECRET_KEY }}" > .env
